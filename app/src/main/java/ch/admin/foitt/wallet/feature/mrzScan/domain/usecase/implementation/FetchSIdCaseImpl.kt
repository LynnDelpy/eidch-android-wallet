...
class FetchSIdCaseImpl @Inject constructor(
    ...
    private val getCurrentClientAttestation: GetCurrentClientAttestation,
    ...
    override suspend fun invoke(applyRequest: ApplyRequest): Result<CaseResponse, ApplyRequestError> = coroutineBinding {
        val clientAttestation: ClientAttestation = getCurrentClientAttestation().firstOrNull()
            ?: Err<ApplyRequestError>(EIdRequestError.Unexpected(IllegalStateException("Missing current client attestation"))).bind()
